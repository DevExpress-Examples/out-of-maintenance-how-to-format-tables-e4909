...
Namespace WindowsFormsApplication1
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			CType(Me.comboBuiltInTableStyles.Properties, System.ComponentModel.ISupportInitialize).BeginInit()
			Me.SuspendLayout()
			' 
			' spreadsheetControl1
			' 
			...
			Me.spreadsheetControl1.Size = New System.Drawing.Size(743, 515)
			...
			Me.splitContainerControl1.Size = New System.Drawing.Size(1062, 515)
...
'			Me.btnCreateCustomTableStyle.Click += New System.EventHandler(Me.btnCreateCustomTableStyle_Click);
			' 
			...
			Me.btnDuplicateTableStyle.Text = "Duplicate and modify the selected built-in table style." & Constants.vbCrLf & "Apply the new style to a" & " table."
			Me.btnDuplicateTableStyle.UseVisualStyleBackColor = True
'			Me.btnDuplicateTableStyle.Click += New System.EventHandler(Me.btnDuplicateTableStyle_Click);
			' 
			' groupControl2
			' 
...
'			Me.btnChangeDefaultStyle.Click += New System.EventHandler(Me.btnChangeDefaultStyle_Click);
			' 
			' btnCreateNewTable
			' 
...
'			Me.btnCreateNewTable.Click += New System.EventHandler(Me.btnCreateNewTable_Click);
			' 
			' labelControl1
			' 
			...
			Me.comboBuiltInTableStyles.Size = New System.Drawing.Size(122, 22)
			Me.comboBuiltInTableStyles.TabIndex = 4
'			Me.comboBuiltInTableStyles.SelectedIndexChanged += New System.EventHandler(Me.comboBuiltInTableStyles_SelectedIndexChanged);
			' 
			' defaultLookAndFeel1
			' 
			Me.defaultLookAndFeel1.LookAndFeel.Style = DevExpress.LookAndFeel.LookAndFeelStyle.Flat
			' 
			' Form1
			' 
			...
			CType(Me.comboBuiltInTableStyles.Properties, System.ComponentModel.ISupportInitialize).EndInit()
		...
		Private WithEvents comboBuiltInTableStyles As DevExpress.XtraEditors.ComboBoxEdit
